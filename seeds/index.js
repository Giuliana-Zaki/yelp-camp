...
const seedDB = async () => {
  ...
  for (let i = 0; i < 200; i++) {
    ...
    const camp = new Campground({
      ...
      images: [
        {
          url: 'https://res.cloudinary.com/dmjwbfeyr/image/upload/v1701339536/YelpCamp/ixz8ek4nxcoitw0cq9ka.jpg',
          filename: 'YelpCamp/ixz8ek4nxcoitw0cq9ka'
        },
        {
          url: 'https://res.cloudinary.com/dmjwbfeyr/image/upload/v1701339536/YelpCamp/j0mdjadkzd3ngmpjsqbm.jpg',
